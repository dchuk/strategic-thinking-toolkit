...
- The Pyramid Principle is an **Up-phase tool**. It produces Clarity before you have the answer. At the end of the project, apply it again for Conviction — see [`../skills/strategic-thinking-toolkit/references/tools/pyramid-principle.md`](../skills/strategic-thinking-toolkit/references/tools/pyramid-principle.md) for the late-project (Conviction) variant.
...
- For issues where numbers dominate, consider switching to a Down-phase tool such as Landscape Analysis ([`../skills/strategic-thinking-toolkit/references/tools/landscape-analysis.md`](../skills/strategic-thinking-toolkit/references/tools/landscape-analysis.md)) after the pyramid establishes structure.
- Facilitation tips for running this exercise with a team (Post-it etiquette, room setup, team size for Up-phase sessions) are in [`../skills/strategic-thinking-toolkit/references/topics/facilitation-tips.md`](../skills/strategic-thinking-toolkit/references/topics/facilitation-tips.md).
- Anti-patterns relevant to this command (HiPPO Curse, Data-holic, and others) are catalogued in [`../skills/strategic-thinking-toolkit/references/anti-patterns/anti-patterns-catalog.md`](../skills/strategic-thinking-toolkit/references/anti-patterns/anti-patterns-catalog.md).
